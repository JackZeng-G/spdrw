...
- 生成时间：2026-09-20 05:19（UTC）；入库时裁掉了内容重复/无法判世的副本
- 有效样本：**67 份**（DDR3 256 B × 29；DDR4 512 B × 21；DDR5 1024 B × 17 —— 含 9 份
  `.spd` 文本 hexdump 样本，解析时先转字节；`TestRealDumpCorpus` 实测 67/67 解析成功、CRC 全过）
- 负样本：`corrupt/` 目录 9 个
